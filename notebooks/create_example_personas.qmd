...
biodt.recreation::save_persona(persona, "test_persona.csv", "random")
```
...
loaded_persona <- biodt.recreation::load_persona("test_persona.csv")
...
biodt.recreation::save_persona(hr_persona, "examples.csv", "Hard_Recreationalist")
biodt.recreation::save_persona(sr_persona, "examples.csv", "Soft_Recreationalist")
